...
#### How to Setup?
This was actually the gizmo I showed in that minimal example above, but if you need more in depth examples of how to use this gizmo, check out my [J-CSG_2D](https://github.com/Javlin-Joslin/J-CSG_2D) plugin where I use it extensively for modifying custom CSG shapes in the viewport.
